...
public interface HttpRuleOrBuilder extends
   ...
   * @return The custom.
   */
  com.google.api2.CustomHttpPattern getCustom();
  /**
   * <pre>
   * The custom pattern is used for specifying an HTTP method that is not
   * included in the `pattern` field, such as HEAD, or "*" to leave the
   ...
   * <code>.google.api.CustomHttpPattern custom = 8;</code>
   */
  com.google.api2.CustomHttpPatternOrBuilder getCustomOrBuilder();
   ...
   */
  java.util.List<com.google.api2.HttpRule> 
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  com.google.api2.HttpRule getAdditionalBindings(int index);
  /**
   * <pre>
   * Additional HTTP bindings for the selector. Nested bindings must
   * not contain an `additional_bindings` field themselves (that is,
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  java.util.List<? extends com.google.api2.HttpRuleOrBuilder> 
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  com.google.api2.HttpRuleOrBuilder getAdditionalBindingsOrBuilder(
      int index);

  public com.google.api2.HttpRule.PatternCase getPatternCase();
}
